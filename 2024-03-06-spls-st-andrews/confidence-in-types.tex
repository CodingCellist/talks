...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item<7-> The problem is\hspace*{2mm} \mintinline{Idris}{Vect n Nat}
      \item<8-> Or even\hspace*{2mm} \mintinline{Idris}{Vect n t}
    \end{itemize}
  \end{itemize}
...
\begin{frame}[fragile]
  ...
  \item<1-> To generate an arbitrary vector, we generate \textit{some}
            length\dots
  \item<2-> \dots\ and then generate that many \mintinline{Idris}{arbitrary}
            elements
  \end{itemize}
