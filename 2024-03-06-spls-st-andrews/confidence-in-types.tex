...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item<6-> The problem is\hspace*{2mm} \mintinline{Idris}{Vect n Nat}
      \item<7-> Or even\hspace*{2mm} \mintinline{Idris}{Arbitrary t => Vect n t}
    \end{itemize}
  \end{itemize}
...
record DPair a (p : a -> Type) where
  ...
  snd : p fst
    ...
    \item<3-> As long as we know how to generate an {\textasciigrave
              \mintinline{Idris}{Arbitrary a}\textasciigrave}, we can generate an
              {\textasciigrave\mintinline{Idris}{Arbitrary (x : a ** p x)}\textasciigrave}
    \begin{itemize}
...
%%         \mintinline{Idris}{arbitrary}\textasciigrave elements
%%   \end{itemize}
%% 
%%   \vspace*{-5mm}
%% 
